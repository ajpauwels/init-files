...
# Default to coloring ls output
alias ls='ls -l --color'

# Define la to list hidden files and directories
alias la='ls -al --color'

# Open emacs maximized in the background
alias e='bs emacs -mm'

# Add the clip command which copies an entire file to the x clipboard
alias clip='function _clip() { cat "$1" | xclip -i -selection clipboard; };_clip'
